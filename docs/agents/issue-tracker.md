...
This repo does not treat external pull requests as feature requests for triage. Skills should triage GitHub Issues only.

If this changes later, update this section to `yes` and use the `gh pr` equivalents:
